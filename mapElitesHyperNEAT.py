...
if __name__ == '__main__':
    with open("hyperNEATStats11.pkl", 'rb') as f:
        stats = pickle.load(f)
    with open("hyperNEATStats11.pkl", 'rb') as f:
        stats1 = pickle.load(f)
    with open("hyperNEATStats11.pkl", 'rb') as f:
        stats2 = pickle.load(f)
    genomes = stats.best_unique_genomes(50)
    ...
    archive = cvt_map_elites.compute(6, genomes, evaluate_gait, n_niches=20000, max_evals=1e6,
                                     log_file=open('mapElitesOutput/HyperNEAT/log1.dat', 'w'), archive_file='mapElitesOutput/HyperNEAT/archiveTest', params=params,
